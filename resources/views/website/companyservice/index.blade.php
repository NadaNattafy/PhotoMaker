                ...
                <div class="card-box">
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$companyservice->services->name}}</td>
                                <td>{{$companyservice->company->name}}</td>
                                <td>
                                    <a class="btn btn-info" href="{{ route('companyservice.show',$companyservice->id) }}">Show</a>
                                    <a class="btn btn-primary" href="{{ route('companyservice.edit',$companyservice->id) }}">Edit</a>
                                    <form action="{{ route('companyservice.destroy',$companyservice->id) }}" method="POST">
