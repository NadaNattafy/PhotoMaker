...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="mt-0 header-title">Company Service</h4>

<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Add New Company Service</h2>
        </div>
...
<form action="{{ route('companyservice.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
